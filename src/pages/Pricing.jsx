...
function FaqItem({ q, a }) {
  ...
  return (
    <div style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
      ...
      {open && (
        <p style={{ fontSize: '0.875rem', color: 'rgba(240,235,224,0.55)', lineHeight: 1.65, margin: '0 0 20px', fontFamily: "'Manrope', sans-serif" }}>
          {a}
        </p>
      )}
    </div>
    ...
    <div style={{
      ...
      <section style={{ maxWidth: 1180, margin: '0 auto', padding: '80px 28px 56px', textAlign: 'left' }}>
        <div style={{
          ...
          <span style={{ fontSize: '0.7rem', fontWeight: 800, color: '#F47B20', letterSpacing: '0.09em', textTransform: 'uppercase', fontFamily: "'Manrope', sans-serif" }}>
            ...
            {PLANS.map((plan, i) => {
              ...
              return (
                ...
                >
                  ...
                  {price.billing ? (
                    <div style={{ fontSize: '0.73rem', color: 'rgba(240,235,224,0.35)', fontFamily: "'Manrope', sans-serif", marginBottom: 16, minHeight: 18 }}>
                      {price.billing}
                    </div>
                  ) : (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 20 }}>
            {[
              ...
              <div key={item.title} style={{ background: '#0E0E0E', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: '22px 20px', textAlign: 'left' }}>
                ...
                <div style={{ fontSize: '0.875rem', fontWeight: 700, color: '#F0EBE0', marginBottom: 5, fontFamily: "'Manrope', sans-serif" }}>{item.title}</div>
                <div style={{ fontSize: '0.8rem', color: 'rgba(240,235,224,0.45)', lineHeight: 1.5, fontFamily: "'Manrope', sans-serif" }}>{item.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ background: 'linear-gradient(135deg, #111 0%, #1a0e05 50%, #111 100%)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: 680, margin: '0 auto', padding: '72px 28px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="#waitlist" onClick={() => onBack && onBack()}
              style={{ padding: '13px 28px', background: '#F47B20', color: '#fff', borderRadius: 8, fontSize: '0.95rem', fontWeight: 700, textDecoration: 'none', fontFamily: "'Manrope', sans-serif", letterSpacing: '0.02em', transition: 'background 0.15s, box-shadow 0.15s' }}
            ...
            <a href="#contact"
              style={{ padding: '13px 28px', background: 'transparent', color: '#F0EBE0', border: '1.5px solid rgba(255,255,255,0.14)', borderRadius: 8, fontSize: '0.95rem', fontWeight: 600, textDecoration: 'none', fontFamily: "'Manrope', sans-serif", transition: 'border-color 0.15s' }}
      ...
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '24px 28px', textAlign: 'center' }}>
        <p style={{ fontSize: '0.78rem', color: 'rgba(240,235,224,0.3)', margin: 0, fontFamily: "'Manrope', sans-serif" }}>
