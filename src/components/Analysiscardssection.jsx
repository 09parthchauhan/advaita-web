          ...
          <div className="analysis-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
            ...
            <div className={`scroll-reveal ${visible ? 'is-visible' : ''}`} style={{ background: '#111111', borderRadius: '0px', overflow: 'hidden', minHeight: '440px', padding: '32px', position: 'relative', display: 'flex', flexDirection: 'column', transitionDelay: '0.42s' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', flex: 1, position: 'relative', zIndex: 1 }}>
                {/* Trigger */}
                <div>
                  <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#f5820a', color: '#fff', fontSize: '10px', fontWeight: '700', padding: '4px 10px', borderRadius: '0px', marginBottom: '8px' }}>
                    <span>⚡</span> Trigger
                  </div>
                  <div style={{ background: 'rgba(255,255,255,0.08)', border: '0.5px solid rgba(255,255,255,0.12)', borderRadius: '0px', padding: '12px 14px' }}>
                ...
                {/* Then 1 */}
                <div>
                  <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#4a9e1a', color: '#fff', fontSize: '10px', fontWeight: '700', padding: '4px 10px', borderRadius: '0px', marginBottom: '8px' }}>
                    <span>⚡</span> Then
                  </div>
                  <div style={{ background: 'rgba(255,255,255,0.06)', border: '0.5px solid rgba(255,255,255,0.1)', borderRadius: '0px', padding: '12px 14px' }}>
            ...
            {/* Card 2 — Web Analysis */}
            <div className={`scroll-reveal ${visible ? 'is-visible' : ''}`} style={{ background: '#f5820a', borderRadius: '0px', overflow: 'hidden', minHeight: '440px', padding: '32px', position: 'relative', display: 'flex', flexDirection: 'column', transitionDelay: '0.58s' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', flex: 1, position: 'relative', zIndex: 1 }}>
                <div style={{ background: '#fff4df', border: '0.5px solid rgba(17,17,17,0.14)', borderRadius: '0px', padding: '16px' }}>
                ...
                <div style={{ background: '#111111', border: '0.5px solid rgba(17,17,17,0.2)', borderRadius: '0px', padding: '14px 16px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginTop: 'auto' }}>
                  {[
                    ...
                    <div key={label} style={{ background: '#fff4df', border: '0.5px solid rgba(17,17,17,0.14)', borderRadius: '0px', padding: '13px' }}>
            ...
            <div className={`scroll-reveal ${visible ? 'is-visible' : ''}`} style={{ background: '#dcefd6', borderRadius: '0px', overflow: 'hidden', minHeight: '440px', padding: '32px', position: 'relative', display: 'flex', flexDirection: 'column', transitionDelay: '0.74s' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', flex: 1, position: 'relative', zIndex: 1 }}>
                {/* Alert tag */}
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#f5820a', color: '#fff', fontSize: '10px', fontWeight: '700', padding: '5px 12px', borderRadius: '0px', width: 'fit-content', marginBottom: '4px' }}>
                  <span>⚡</span> Session drop detected
                </div>
  
                {/* Insight card */}
                <div style={{ background: '#fff', borderRadius: '0px', padding: '18px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '14px' }}>
                    <div style={{ width: '28px', height: '28px', borderRadius: '0px', background: 'linear-gradient(135deg, #f5820a, #f5d800)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '14px' }}>✦</div>
                  ...
                  {[
                    ...
                    <div key={m.label} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: '#f6f6f1', borderRadius: '0px', padding: '10px 14px', marginBottom: '8px' }}>
                ...
                <div style={{ display: 'flex', gap: '8px', marginTop: '4px' }}>
                  {[{ name: 'iOS', color: '#111' }, { name: 'Android', color: '#4a9e1a' }, { name: 'Flutter', color: '#54C5F8' }, { name: 'React Native', color: '#61DAFB' }].map(p => (
                    <div key={p.name} style={{ background: 'rgba(255,255,255,0.7)', border: `1px solid ${p.color}30`, borderRadius: '0px', padding: '5px 10px', fontSize: '10px', fontWeight: '600', color: p.color }}>
                      {p.name}
                    </div>
                  ))}
                </div>
