    ...
    <div style={{
      ...
      <div style={{ width: '100%', background: 'rgba(255,255,255,0.03)', borderRadius: 14, padding: '14px 16px', border: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
          <span style={{ fontSize: 10, color: 'rgba(240,235,224,0.5)', fontFamily: "'Manrope', sans-serif", fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Event Volume · 12h</span>
          <span style={{ fontSize: 12, fontWeight: 700, color: '#F47B20', fontFamily: "'Manrope', sans-serif" }}>↑ 24.3%</span>
        </div>
      ...
      <div style={{ display: 'flex', gap: 10, width: '100%' }}>
        {[
          ...
          <div key={label} style={{
            ...
            <div style={{ fontSize: 9, color: 'rgba(240,235,224,0.4)', fontFamily: "'Manrope', sans-serif", textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 4 }}>{label}</div>
            <div style={{ fontSize: 15, fontWeight: 700, color, fontFamily: "'Manrope', sans-serif" }}>{value}</div>
          </div>
        ))}
      </div>
    </div>
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 1, padding: '32px 32px 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <Logo size={36} />
          <span style={{ fontFamily: "'Manrope', sans-serif", fontWeight: 700, fontSize: '1.15rem', color: '#F0EBE0', letterSpacing: '-0.01em' }}>Advaita</span>
        </div>
        <div style={{ marginTop: 20, paddingLeft: 2 }}>
          ...
          <p style={{ fontFamily: "'Manrope', sans-serif", fontSize: '0.8rem', color: 'rgba(240,235,224,0.45)', marginTop: 10, lineHeight: 1.6, fontWeight: 300 }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, padding: '0 32px 28px' }}>
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.07)', paddingTop: 18, display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 11, fontWeight: 600, color: '#F0EBE0', fontFamily: "'Manrope', sans-serif" }}>1.4M+ engineers tracking</div>
            <div style={{ fontSize: 10, color: 'rgba(240,235,224,0.4)', fontFamily: "'Manrope', sans-serif" }}>Join the waitlist today</div>
          </div>
        </div>
      </div>
    </div>
...
function Field({ label, type = 'text', placeholder, value, onChange, autoComplete }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
      <label style={{ fontSize: '0.78rem', fontWeight: 600, color: '#475569', fontFamily: "'Manrope', sans-serif", letterSpacing: '0.02em' }}>
        {label}
      </label>
